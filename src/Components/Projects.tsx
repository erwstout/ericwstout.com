...
const projects: Projects = [
  {
    ...
    description: `Elevate-UI is a library of React Components that can be reused throughout a project to achieve consistent styling results. (contributer)`
  },
  {
    name: "macCMS (working title)",
    url: "https://github.com/erwstout/macCMS",
    keywords: [
      "react",
      "javascript",
      "es6",
    ...
    description: `macCMS is a CMS system that is currently under development. It is built on Node/Express with an admin panel built in React. The database is managed with Postgres and allows for user creation/deletion, post creation/deletion, and more.`
  },
  {
  ...
  },
  {
    ...
    keywords: ["scss", "framework", "open source"],
  ...
  },
  {
    ...
    keywords: ["javascript", "node", "es6", "open source", "api"],
  ...
  },
  {
    ...
    keywords: ["wordpress plugin", "php", "rest", "open source", "api"],
  ...
  },
  {
    ...
    keywords: ["react", "material ui", "rest", "api"],
    description: `This project was built with React while working at factor1 to generate leads by using the GTmetrix API to analyze a user's site speed and then do calculations for projected revenue when site speed is increased.`
  }
];
...
const Projects: React.FC = () => (
  <div style={styles.container}>
    <Helmet>
      ...
      <meta
        name="description"
        content="A collections of projects by Eric Stout"
      />
    </Helmet>
    <div className="container">
      <div className="row">
        <div className="col-12">
          ...
          <p>
            A collection of really really cool projects I've had the pleasure to
            work on.
          </p>
          <div className="block-grid-4 md-block-grid-3 sm-block-grid-1">
            {projects.map((project, i) => (
              <ProjectItem key={`project${i}`} {...project} />
            ))}
          </div>
        </div>
      </div>
